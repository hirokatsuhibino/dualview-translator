...
var DVT_I18N = (function () {
  ...
  const MESSAGES = {
    ja: {
      ...
      fallbackToApple: 'オフラインのため Apple 翻訳に切替えました',
      close: '閉じる',
      // content — 翻訳バー
    ...
    en: {
      ...
      fallbackToApple: 'Switched to Apple Translation (offline)',
      close: 'Close',
    ...
    'zh-CN': {
      ...
      fallbackToApple: '已切换到 Apple 翻译（离线）',
      close: '关闭',
    ...
    'zh-TW': {
      ...
      fallbackToApple: '已切換至 Apple 翻譯（離線）',
      close: '關閉',
    ...
    ko: {
      ...
      fallbackToApple: '오프라인으로 인해 Apple 번역으로 전환했습니다',
      close: '닫기',
    ...
    fr: {
      ...
      fallbackToApple: 'Basculé sur la traduction Apple (hors ligne)',
      close: 'Fermer',
    ...
    de: {
      ...
      fallbackToApple: 'Zur Apple-Übersetzung gewechselt (offline)',
      close: 'Schließen',
    ...
    es: {
      ...
      fallbackToApple: 'Cambiado a traductor Apple (sin conexión)',
      close: 'Cerrar',
    ...
    pt: {
      ...
      fallbackToApple: 'Alternado para tradutor Apple (offline)',
      close: 'Fechar',
    ...
    ru: {
      ...
      fallbackToApple: 'Переключено на Apple Переводчик (офлайн)',
      close: 'Закрыть',
    ...
    ar: {
      ...
      fallbackToApple: 'تم التبديل إلى ترجمة Apple (دون اتصال)',
      close: 'إغلاق',
