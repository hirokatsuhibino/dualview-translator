...
var DVT_I18N = (function () {
  ...
  const MESSAGES = {
    ja: {
      ...
      backupImportLabel: 'JSONを貼り付けてインポート',
      backupImportPlaceholder: 'エクスポートしたJSONの中身を貼り付け',
    ...
    en: {
      ...
      backupImportLabel: 'Paste JSON to import',
      backupImportPlaceholder: 'Paste the contents of an exported JSON here',
    ...
    'zh-CN': {
      ...
      backupImportLabel: '粘贴 JSON 进行导入',
      backupImportPlaceholder: '粘贴导出的 JSON 内容',
    ...
    'zh-TW': {
      ...
      backupImportLabel: '貼上 JSON 進行匯入',
      backupImportPlaceholder: '貼上匯出的 JSON 內容',
    ...
    ko: {
      ...
      backupImportLabel: 'JSON 붙여넣어 가져오기',
      backupImportPlaceholder: '내보낸 JSON 내용을 붙여넣으세요',
    ...
    fr: {
      ...
      backupImportLabel: 'Coller le JSON pour importer',
      backupImportPlaceholder: "Colle ici le contenu d'un JSON exporté",
    ...
    de: {
      ...
      backupImportLabel: 'JSON zum Importieren einfügen',
      backupImportPlaceholder: 'Inhalt einer exportierten JSON hier einfügen',
    ...
    es: {
      ...
      backupImportLabel: 'Pega el JSON para importar',
      backupImportPlaceholder: 'Pega aquí el contenido de un JSON exportado',
    ...
    pt: {
      ...
      backupImportLabel: 'Cole o JSON para importar',
      backupImportPlaceholder: 'Cole aqui o conteúdo de um JSON exportado',
    ...
    ru: {
      ...
      backupImportLabel: 'Вставьте JSON для импорта',
      backupImportPlaceholder: 'Вставьте сюда содержимое экспортированного JSON',
    ...
    ar: {
      ...
      backupImportLabel: 'الصق JSON للاستيراد',
      backupImportPlaceholder: 'الصق محتوى ملف JSON المُصدَّر هنا',
