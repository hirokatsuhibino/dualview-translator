...
var DVT_I18N = (function () {
  ...
  const MESSAGES = {
    ja: {
      ...
      backupImportInvalid: '無効な設定ファイルです。DualView Translatorのエクスポートファイルを選択してください。',
      backupImportConfirm: '現在の設定をインポート内容で上書きします。よろしいですか？',
      backupImportDone: '設定をインポートしました。ポップアップを再読み込みします。',
    ...
    en: {
      ...
      backupImportInvalid: "That's not a valid settings file. Pick a JSON exported from DualView Translator.",
      backupImportConfirm: 'This will overwrite your current settings with the imported ones. Continue?',
      backupImportDone: 'Settings imported. Reloading the popup.',
    ...
    'zh-CN': {
      ...
      backupImportInvalid: '设置文件无效。请选择 DualView Translator 导出的 JSON。',
      backupImportConfirm: '将用导入的内容覆盖当前设置。是否继续？',
      backupImportDone: '已导入设置。即将重新加载弹窗。',
    ...
    'zh-TW': {
      ...
      backupImportInvalid: '無效的設定檔。請選擇由 DualView Translator 匯出的 JSON。',
      backupImportConfirm: '將以匯入內容覆寫目前設定。是否繼續？',
      backupImportDone: '已匯入設定。將重新載入彈出視窗。',
    ...
    ko: {
      ...
      backupImportInvalid: '잘못된 설정 파일입니다. DualView Translator에서 내보낸 JSON을 선택하세요.',
      backupImportConfirm: '현재 설정을 가져온 내용으로 덮어씁니다. 계속할까요?',
      backupImportDone: '설정을 가져왔습니다. 팝업을 다시 불러옵니다.',
    ...
    fr: {
      ...
      backupImportInvalid: 'Fichier de réglages invalide. Choisis un JSON exporté depuis DualView Translator.',
      backupImportConfirm: 'Cela va remplacer tes réglages actuels par ceux importés. Continuer ?',
      backupImportDone: 'Réglages importés. Rechargement du popup.',
    ...
    de: {
      ...
      backupImportInvalid: 'Ungültige Einstellungsdatei. Wähl ein von DualView Translator exportiertes JSON.',
      backupImportConfirm: 'Damit werden deine aktuellen Einstellungen mit der Import-Datei überschrieben. Fortfahren?',
      backupImportDone: 'Einstellungen importiert. Popup wird neu geladen.',
    ...
    es: {
      ...
      backupImportInvalid: 'Archivo de ajustes no válido. Elige un JSON exportado desde DualView Translator.',
      backupImportConfirm: 'Esto reemplazará tus ajustes actuales con los importados. ¿Continuar?',
      backupImportDone: 'Ajustes importados. Recargando el popup.',
    ...
    pt: {
      ...
      backupImportInvalid: 'Arquivo de configurações inválido. Escolha um JSON exportado do DualView Translator.',
      backupImportConfirm: 'Isso vai sobrescrever suas configurações atuais com as do arquivo. Continuar?',
      backupImportDone: 'Configurações importadas. Recarregando o popup.',
    ...
    ru: {
      ...
      backupImportInvalid: 'Недействительный файл настроек. Выберите JSON, экспортированный из DualView Translator.',
      backupImportConfirm: 'Текущие настройки будут заменены импортированными. Продолжить?',
      backupImportDone: 'Настройки импортированы. Перезагрузка всплывающего окна.',
    ...
    ar: {
      ...
      backupImportInvalid: 'ملف إعدادات غير صالح. اختر JSON تم تصديره من DualView Translator.',
      backupImportConfirm: 'سيؤدي هذا إلى استبدال الإعدادات الحالية بالمستوردة. هل تريد المتابعة؟',
      backupImportDone: 'تم استيراد الإعدادات. جارٍ إعادة تحميل النافذة المنبثقة.',
